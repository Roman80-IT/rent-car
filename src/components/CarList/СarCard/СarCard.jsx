...
// import FavoritesNormalIcon from "../../assets/icons/fav-normal.svg";
// import { ReactComponent as FavoritesNormalIcon } from "../../assets/icons/fav-normal.svg";

export const СarCard = ({ item }) => {
  const {
    id,
    address,
    make,
  ...
  return (
    <StyledCard>
      ...
      {isModalOpen && (
        <CarModal close={closeModal} data={{ item, city, country }}></CarModal>
      )}
    </StyledCard>
  );
};
